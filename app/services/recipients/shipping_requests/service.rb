  ...
  module ShippingRequests
    class Service
      def initialize(
        ...
        shipping_request_repository: ::Recipients::ShippingRequests::MockedRepository.new
      )
      ...
      def shipping_request(recipient, shipping_request_id)
        shipping_request_repository.find(user_id: recipient.id, id: shipping_request_id)
      end
    end
  end
end
