...
export const ShippingRequestsItem: FunctionComponent<IShippingRequestItem> = ({ id, attributes, onClick, isLast, isEven, classes }) => {
  ...
  return (
    <>
      <TableRow onClick={handleClick} className={`${classes.head} ${isEven && classes.even} ${isOpen && classes.active}`}>
